...
class LinkedList:
    ...
    def cursor_insert(self, value):
        ...
        new = self.Node(value, prior=self.cursor, next=self.cursor.next)
    ...
    def insert(self, idx, value):
        ...
        for x in range(idx):
          cur = cur.next
        new = self.Node(value, prior=cur, next=cur.next)
        cur.next.prior = new
        cur.next = new
        self.length +=1
